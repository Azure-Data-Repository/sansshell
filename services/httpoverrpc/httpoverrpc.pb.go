...
var file_httpoverrpc_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x73, 0x22, 0x9d, 0x01, 0x0a, 0x0b, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x71,
	...
	0x70, 0x6f, 0x72, 0x74, 0x22, 0x6f, 0x0a, 0x09, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x70, 0x6c,
	...
	0x04, 0x62, 0x6f, 0x64, 0x79, 0x32, 0x4e, 0x0a, 0x0b, 0x48, 0x54, 0x54, 0x50, 0x4f, 0x76, 0x65,
	0x72, 0x52, 0x50, 0x43, 0x12, 0x3f, 0x0a, 0x09, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f, 0x73,
	0x74, 0x12, 0x18, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x4f, 0x76, 0x65, 0x72, 0x52, 0x50, 0x43, 0x2e,
...
var file_httpoverrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_httpoverrpc_proto_goTypes = []interface{}{
	(*Header)(nil),      // 0: HTTPOverRPC.Header
	(*HTTPRequest)(nil), // 1: HTTPOverRPC.HTTPRequest
	(*HTTPReply)(nil),   // 2: HTTPOverRPC.HTTPReply
}
var file_httpoverrpc_proto_depIdxs = []int32{
	0, // 0: HTTPOverRPC.HTTPRequest.headers:type_name -> HTTPOverRPC.Header
	0, // 1: HTTPOverRPC.HTTPReply.headers:type_name -> HTTPOverRPC.Header
	1, // 2: HTTPOverRPC.HTTPOverRPC.Localhost:input_type -> HTTPOverRPC.HTTPRequest
	2, // 3: HTTPOverRPC.HTTPOverRPC.Localhost:output_type -> HTTPOverRPC.HTTPReply
