...
type HTTPOverRPCClient interface {
	...
	Localhost(ctx context.Context, in *HTTPRequest, opts ...grpc.CallOption) (*HTTPReply, error)
}
...
func (c *hTTPOverRPCClient) Localhost(ctx context.Context, in *HTTPRequest, opts ...grpc.CallOption) (*HTTPReply, error) {
	out := new(HTTPReply)
...
type HTTPOverRPCServer interface {
	// Make an HTTP call to localhost
	Localhost(context.Context, *HTTPRequest) (*HTTPReply, error)
}
...
func (UnimplementedHTTPOverRPCServer) Localhost(context.Context, *HTTPRequest) (*HTTPReply, error) {
...
func _HTTPOverRPC_Localhost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HTTPOverRPCServer).Localhost(ctx, req.(*HTTPRequest))
	}
