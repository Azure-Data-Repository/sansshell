...
type HTTPOverRPCClientProxy interface {
	HTTPOverRPCClient
	LocalhostOneMany(ctx context.Context, in *HTTPRequest, opts ...grpc.CallOption) (<-chan *LocalhostManyResponse, error)
}
...
func (c *hTTPOverRPCClientProxy) LocalhostOneMany(ctx context.Context, in *HTTPRequest, opts ...grpc.CallOption) (<-chan *LocalhostManyResponse, error) {
